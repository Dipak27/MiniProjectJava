 ...
 * Generated at: 2016-09-20 10:11:50 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t  \t\t\t<p> Java Tutorial or Core Java Tutorial or Java Programming Tutorial is a widely used robust technology. Let's start learning of java from basic questions like what is java tutorial, core java, where it is used, what type of\r\n");
      out.write("\t\t\t\t\t\t  \t\t\t applications are created in java and why use java.</p>\r\n");
      out.write("\t\t\t\t\t\t  \t\t\t <p>Java is a programming language and a platform.\r\n");
      out.write("\r\n");
      out.write("Java is a high level, robust, secured and object-oriented programming language.\r\n");
      out.write("\r\n");
      out.write("Platform: Any hardware or software environment in which a program runs, is known as a platform. Since Java has its own runtime environment (JRE) and API, it is called platform.</p>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
