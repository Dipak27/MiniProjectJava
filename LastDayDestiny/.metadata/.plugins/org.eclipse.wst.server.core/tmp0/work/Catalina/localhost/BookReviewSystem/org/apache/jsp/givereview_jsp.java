 ...
 * Generated at: 2016-09-20 10:51:41 UTC
...
ResultSet resultset2 =null;
 ...
 out.println(username); 
      ...
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<form id=\"frmMain2\"  class=\"frmMain\" action=\"ReviewServlet\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<table class=\"form-table\" style=\"width:auto\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea id=\"addreview\"  class=\"validate[required]  class=\"validate[maxSize[200]]\" style=\"width:99%\" cols=\"10\" rows=\"3\"  name=\"addreview\" placeholder=\"Maximum 200 Characters\" value=\"\" ></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td><a href='modifyreview.jsp?reviewid=+");
      out.print( reviewid );
      out.write("+'>Modify</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td><a href='deletereview.jsp?reviewid=+");
      out.print( reviewid );
