 ...
 * Generated at: 2016-09-20 12:19:39 UTC
...
public final class registration_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tvar relTag = \"registration\";\r\n");
      out.write("\t\t</script>\r\n");
      out.write("\t\t<script>\r\n");
      out.write("\t\tvar request;  \r\n");
      out.write("\t\tfunction verifyemailid()  \r\n");
      out.write("\t\t{  \r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\tvar v=document.getElementById(\"email\").value;  \r\n");
      out.write("\t\t\tvar url=\"verifyemail.jsp?val=\"+v;  \r\n");
      out.write("\t\t\t  \r\n");
      ...
      out.write("\t\t{  \r\n");
      out.write("\t\t\tif(request.readyState==4 && xmlhttp.status == 200)\r\n");
      out.write("\t\t\t{  \r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar v=request.responseText; \r\n");
      out.write("\t\t\t\tdocument.getElementById(\"message\").innerHTML = v;\r\n");
      out.write("             \t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t} \r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<form action=\"UserServlet\" id=\"frmMain1\" class=\"frmMain\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input id=\"name\" type=\"text\"  class=\"validate[required]\" name=\"name\" style=\"width:120%\" placeholder=\"John Carren\" value=\"\"  />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input id=\"email\" type=\"text\"  class=\"validate[required]\" name=\"email\" style=\"width:120%\" placeholder=\"demo@cybage.com\" value=\"\" onChange=\"verifyemailid()\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input id=\"password\" type=\"password\"  class=\"validate[required]\" name=\"password\" style=\"width:120%\" placeholder=\"password\" value=\"\"  />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input id=\"cpassword\" type=\"password\"  class=\"validate[required]\" name=\"cpassword\" style=\"width:120%\" placeholder=\"password\" value=\"\"  />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<select id=\"Select3\" class=\"validate[required]\"  style=\"width:120%\" name=\"selectsecquestion\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">Select Option</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"nickname\">What is your nick name?</option>\r\n");
      out.write("                                              \t\t\t<option value=\"schoolname\">What is your primary school name?</option>\r\n");
      out.write("                                                  \t\t<option value=\"grandfathername\">What is your grand father name?</option>\r\n");
      out.write("                                                  \t\t<option value=\"firstmobileno\">What is your first mobile number?</option>\r\n");
      out.write("                                                  \t\t\r\n");
      out.write("\t\t                         \t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input id=\"answer\" type=\"text\"  class=\"validate[required]\" name=\"answer\" style=\"width:120%\" placeholder=\"Your answer\" value=\"\"  />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
