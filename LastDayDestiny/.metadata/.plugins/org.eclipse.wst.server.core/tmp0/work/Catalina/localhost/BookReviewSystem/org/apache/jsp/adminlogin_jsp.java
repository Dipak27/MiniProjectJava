 ...
 * Generated at: 2016-09-20 11:14:40 UTC
...
public final class adminlogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<form id=\"frmMain\" class=\"frmMain\" action=\"AdminValidationServlet\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input id=\"email\" type=\"text\"  class=\"validate[required]\" name=\"email\" style=\"width:120%\" placeholder=\"demo@cybage.com\" value=\"\"  />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"news-ticker1\"><span class=\"icon\">&#9734;</span> Must be Registered</ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
