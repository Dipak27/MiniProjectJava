							...
							<div class="padding_20 text-justify">
								<form action="UserServlet" id="frmMain1" class="frmMain" method="post">
									...
									<tr>
											...
											<td>
												<input id="name" type="text"  class="validate[required]" name="name" style="width:120%" placeholder="John Carren" value=""  />
											</td>
										...
										<tr>
											...
											<td>
												<input id="email" type="text"  class="validate[required]" name="email" style="width:120%" placeholder="demo@cybage.com" value="" onChange="verifyemailid()" />
										...
										<tr>
											...
											<td>
												<input id="cpassword" type="password"  class="validate[required]" name="cpassword" style="width:120%" placeholder="password" value=""  />
											</td>
